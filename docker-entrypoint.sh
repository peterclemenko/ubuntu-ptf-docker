...
# set plugin and graphql settings
: ${NEO4J_dbms_unmanaged_extension_classes:="org.neo4j.graphql=/graphql"}


: ${NEO4J_dbms_security_procedures_unrestricted:="*"}

# set graphaware plugins up
# graphaware framework
: ${NEO4J_dbms_unmanaged_extension_classes:="com.graphaware.server=/graphaware"}
# graphaware uuid
...
: ${NEO4J_com_graphaware_module_UIDM_stripHyphens:="false"}

#optional, default is all nodes:
#: ${NEO4J_com.graphaware.module.UIDM.node:="hasLabel('Label1') || hasLabel('Label2')"}

# include uuids on all relationships:
